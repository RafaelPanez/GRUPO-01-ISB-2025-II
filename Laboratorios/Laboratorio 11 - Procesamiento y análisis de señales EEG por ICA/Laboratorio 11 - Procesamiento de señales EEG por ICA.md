...
El componente ICA000 exhibe una distribución espacial con predominio negativo en la región frontal y positivo en la zona occipital, mostrando una señal continua y periódica. Su espectro revela picos bien definidos en torno a 50 Hz y 100 Hz, asociados a una oscilación rítmica constante. De manera similar, ICA001 presenta una topografía opuesta, con una región posterior negativa y un vértex positivo, acompañado de una señal de baja amplitud y frecuencia lenta; en ambos casos, la varianza se mantiene baja y homogénea.

El ICA002 conserva un patrón positivo frontal y central con un leve componente negativo occipital, representando una señal estable, con oscilaciones de baja amplitud y espectro dominado por picos en 50 Hz y 100 Hz. Por su parte, ICA003 muestra un patrón de positividad amplia en áreas frontotemporales y negatividad occipital, manteniendo un comportamiento temporal suave y regular, con baja dispersión de la varianza.

El ICA004 mantiene una morfología semejante, con predominio positivo anterior y lateral, negatividad leve posterior y una señal estable pero de amplitud moderada, que coincide con la actividad observada en la visualización temporal. Tanto su espectro como su varianza reafirman la consistencia de la señal. En contraste, ICA005 muestra una inversión de polaridad, con negatividad pronunciada en la región temporal derecha y positividad frontal, además de un leve evento transitorio centrado en el tiempo cero y actividad oscilatoria sostenida, aunque sin comprometer la estabilidad global del registro.

El ICA006 presenta una topografía similar a la de ICA005, con negatividad en regiones occipitotemporales y positividad central, y una morfología temporal caracterizada por deflexiones leves y constantes. Finalmente, el ICA007 evidencia un patrón cruzado, con alternancia de zonas positivas y negativas de baja amplitud y un espectro nuevamente dominado por los picos de 50 Hz y su armónico.

En conjunto, la información derivada de las topografías, espectros, varianzas y la visualización temporal confirma que el proceso ICA logró una separación efectiva y precisa de las fuentes subyacentes en el registro EEG. Las señales obtenidas son estables, independientes y presentan un bajo nivel de ruido, lo que evidencia un procesamiento exitoso y la obtención de componentes limpios, adecuados para etapas posteriores de interpretación neurofisiológica.
...
Por otro lado, ICA007 exhibe una alternancia simétrica de polaridades que abarca todo el cuero cabelludo, con amplitud mínima y sin picos adicionales fuera del rango de 50 Hz. Este tipo de patrón es característico de componentes residuales de fondo o de ruido térmico de bajo impacto fisiológico, que suelen conservarse tras la separación ICA pero carecen de relevancia funcional.

Finalmente, el estudio de Gonsisko et al. (2023) [4], el cual explora el uso de la metodología iCanClean para mejorar el análisis de ICA en datos de EEG móvil, muestra hallazgos similares en cuanto a la identificación de artefactos de movimiento y la mejora de la calidad de la señal mediante técnicas preprocesamiento. Este estudio encontró que la aplicación de iCanClean antes de aplicar ICA permitió una mejora significativa en la descomposición de las señales, lo que permitió separar de manera más eficaz las fuentes cerebrales de los artefactos. Al igual que en nuestro análisis, el estudio muestra que los componentes de baja frecuencia y ruido eléctrico a 50 Hz son comunes, aunque en su caso, se trabaja con una mayor densidad de canales (más de 32) en comparación con los 8 canales de nuestro estudio. Sin embargo, ambos trabajos coinciden en la importancia del preprocesamiento de la señal para mejorar la calidad del ICA y la separación efectiva de artefactos. Además, tanto nuestro análisis como el de Gonsisko et al. (2023) destacan que componentes como los de actividad muscular o movimientos oculares tienen una amplitud controlada y pueden ser excluidos si es necesario sin comprometer la calidad de la señal cerebral restante. Esto refuerza que un proceso bien diseñado de ICA, respaldado por un adecuado preprocesamiento, puede garantizar la separación de fuentes cerebrales y la minimización de artefactos.
