...
| Imagen | Título | Información |
|--------|--------|-------------|
| <div align="center"><img src="images/myocene.png" width="2000"/></div>| Myocene | El dispositivo permite evaluar la fatigabilidad muscular de los atletas en el campo, facilitando un mejor monitoreo de la fatiga para optimizar el rendimiento mediante entrenamientos adecuados y reducir el riesgo de sobreentrenamiento y lesiones [14]. |
